...
static const char *initI2STAG = "initialize I2S Microphone";
...
void init_microphone(void)
{
    ...
    ESP_LOGI(initI2STAG, "Receive PDM microphone data in PCM format");
#else
    ESP_LOGI(initI2STAG, "Receive PDM microphone data in raw PDM format");
